...
Refine swaybg and the wallpaper presentation without changing the established
output, lock, idle, or power-policy ownership. After that surface is stable,
perform the cross-application GTK and Qt consistency review before styling
tuigreet and Plymouth.
